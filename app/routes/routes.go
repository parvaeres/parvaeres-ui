...
func (_ tApp) Contact() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("App.Contact", args).URL
}

func (_ tApp) DoValidate() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("App.DoValidate", args).URL
}

func (_ tApp) DoSubmit() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("App.DoSubmit", args).URL
}

func (_ tApp) GetDeployment() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("App.GetDeployment", args).URL
}

func (_ tApp) DeleteDeployment() string {
	args := make(map[string]string)

	return revel.MainRouter.Reverse("App.DeleteDeployment", args).URL
}

func (_ tApp) GetDeploymentLogs() string {
	args := make(map[string]string)
